...
function getQuestionsAndAnswers(topicId){
    ...
    switch(topicId){
        case 0:
            ...
            answers = [
                "My name is Matthias HARTMANN.However online i prefer to use the username Iziram",
                "I was born in France, in a town named Brest, near the atlantic ocean",
                ...
                "It might surprise you but my brothers and I were born following a arithmetical sequence with a commmon difference of 2. It is a scientific way to say that I'm 18",
        ...
        case 1:
            ...
            answers = [
                ...
                "I pursue a Network and Telecommunications' degree in Lannion's University Institute of Technology.",
                "Other than the baccalaureate, I have the FCE (Cambridge English: First) and a fencing activity leader degree that allows me to teach fencing.",
        ...
        case 2:
            ...
            answers = [
                ...
                "I made a VSCode extension, I also created multiple plugins (modifications on the server side) for Minecraft, all written in Java, I did some web developping such as this website. In general you can see what projects I have done on <a href='https://github.com/Iziram' target='_blank'>my github</a> or on my website : <a href='https://iziram.fr' target='_blank'>iziram.fr</a>"
            ]
            break;
        case 3:
            label.innerText = "Topic : \nHobbies"
